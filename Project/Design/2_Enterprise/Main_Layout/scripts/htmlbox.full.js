        ...
        var d={
            toolbars:[[
            		...
            		// Left, Right, Center, Justify
               		...
               		// Ordered List, Unordered List, Indent, Outdent, Horizontal rule
               		"separator","ol","ul","indent","outdent","hr",
            		// Formats, Image, Tables, Hyperlink, Remove Hyperlink
            		"separator","image","table","link","unlink","formats",
            		
            		//Strip tags, Source code
            		"separator","removeformat","striptags","code"
            		]],
                idir:"/Project/Design/2_Enterprise/Main_Layout/scripts/images/",// HtmlBox Image Directory, This is needed for the images to work
                icons:"silk",  // Icon set
                about:false,
                ...
                css:"body{margin:3px;font-family:arial;font-size:11px;}p{margin:0px;}",
    ...
    //=====================================================================//
       ...
       // END: Prepare commands
           if(cmd==="code"){
        	   ...
        	   $('#photo_chooser').fadeIn(100);
        	   
        	   $('span.chosen_image').live('click',function(){
	   				image_path	= $(this).attr('title');
	   				
	   				d.idoc.execCommand("insertimage", false, image_path);
	   				keyup();
        	   ...
        	   $('.table_dialog,#popUp_background').fadeIn();
        	   
        	   $('.table_dialog span[title="create"]').live('click',function(){
        		   ...
        		   table ='<table style="border:1px solid #ccc">';
        		   	for(i = 1; i <= rows; i++)
        		   	{
	        		   	...
	        		   	for(j = 1; j<=columns; j++)
	        		   		table += '<td style="border:1px solid #ccc">cell</td>';
        	   ...
        	   //d.idoc.execCommand("createtable", false, prompt("Paste Web Address URL Here:"));
